...
// const BATCH_SIZES: [usize; 2] = [1024, 16384]; //, 131072, 1048576]; These are used against multivariate DeKART
const BATCH_SIZES: [usize; 3] = [1024, 4096, 16384];
...
const BIT_WIDTHS: [usize; 3] = [16, 32, 64];
