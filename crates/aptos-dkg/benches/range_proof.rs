...
// const BATCH_SIZES: [usize; 4] = [1023, 2047, 4095, 131071]; //[1048575]; // 1048575100000, 1000000];
// const BATCH_SIZES: [usize; 3] = [1023, 32767, 1048575];
const BATCH_SIZES: [usize; 3] = [1023, 4095, 16383, 1048575];
...
const BIT_WIDTHS: [u8; 3] = [16, 32, 64];
